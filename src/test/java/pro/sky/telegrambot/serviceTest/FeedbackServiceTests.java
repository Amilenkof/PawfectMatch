...
public class FeedbackServiceTests {
    ...
    @Test
    public void TestAddFeedBack(){//todo странный тест, я вроде захожу в метод проверял логику его работы а потом просто подменяю итоговый результат на нужный и сравниваю
